...
\newcommand\cMonth{六}
\newcommand\cDay{十}
\newcommand\eYear{2019}
\newcommand\eMonth{July}
...
\begin{figure}[htbp]
	...
	\vspace{0.5cm}
	\end{minipage}%
	% \hspace{4.5cm} \makebox[2cm][s]{\Large{學號：}}
\\ 
\rule{16cm}{3pt}
\end{figure}
%\hfill
...
\Large{\myEname}	% Display author's Chinese name 顯示作者中文名
\hfill \makebox[1cm][s]{}\\
%
\vspace{0.3cm}
...
\Large{\advisorEnameA} 	% Display 1st adviser's name 顯示指導教授 A 中文名
\hfill \makebox[1cm][s]{}\\
%
